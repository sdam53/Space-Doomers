...
class PriorityQueue{
    ...
    bubbleUp(){
        ...
        while(index > 0){
            ...
            if(this.values[parentIndex].f > this.values[index].f){
    ...
    bubbleDown(){
        ...
        const elementPriority = this.values[0].f;
        ...
        while (true){
            ...
            if(leftChildIndex < length){
                leftChildPriority = this.values[leftChildIndex].f
            ...
            if(rightChildIndex < length){
                rightChildPriority = this.values[rightChildIndex].f
    ...
    contains(theNode) {
        return this.values.some(node => (node.equals(theNode) && node.f < theNode.f));
    }
}